...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        customAvatar: '15px 20px 30px -5px rgba(0, 0, 0, 0.2), 10px 40px 60px -60px rgba(0, 0, 0, 0.1)', 
        customNavbar: '15px 20px 30px -5px rgba(0, 0, 0, 0.2), 10px 40px 60px -60px rgba(0, 0, 0, 0.1)',
      },

      backgroundNavbar: {
        bg_navbar:'url(/images/hero-bg.svg)',
      },
    },
  },
